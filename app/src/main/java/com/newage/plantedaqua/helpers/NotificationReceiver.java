...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        notificationManager.cancel("com.newage.plantedaqua",NotificationID);
            ...
            if(AType.equals("Dosing") && AName.equals("Macro") && STATUS.equals(context.getResources().getString(R.string.Completed))) {
                ...
                if (remoteInput != null) {
                    ...
                    if(!TextUtils.isEmpty(waterChange)) {
                        ...
                        notificationHelper.getManager().notify("com.newage.plantedaqua", NotificationID, repliedNotification.build());
                    }
                    //endregion
