...
public class RecyclerAdapterTankItems extends RecyclerView.Adapter<RecyclerAdapterTankItems.RecyclerViewHolder>{
    ...
    RecyclerAdapterTankItems(ArrayList<TankItems> arrayList,String category, Context context, RecyclerAdapterTankItems.OnItemClickListener onItemClickListener){
