...
String tankName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // System.out.println("Aqua ID : "+aquaID);
        ...
        Button algaebutton =  findViewById(R.id.algaeguide);

        algaebutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i3 = new Intent(view.getContext(), AlgaeActivity.class);
                startActivity(i3);
        ...
        LogsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i8 = new Intent(view.getContext(), Logs.class);
