package com.newage.aquapets.fragments.tankitems
...
import com.newage.aquapets.databinding.FragmentCreateTankItemsBinding
...
class CreateTankItemsFragment : Fragment(), View.OnClickListener {
   ...
   private val SELECT_FILE = 31
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        tankItemListViewModel.getEachTankItemLiveData().observe(viewLifecycleOwner) {
        ...
        tankItemListViewModel.getDisplayImageUri().observe(viewLifecycleOwner) {
