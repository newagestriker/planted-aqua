...
import com.newage.aquapets.helpers.NotificationHelper;
import com.newage.aquapets.dbhelpers.TankDBHelper;
import com.newage.aquapets.helpers.TinyDB;
import com.newage.aquapets.helpers.NotificationReceiver;
...
public class RamizAlarm extends BroadcastReceiver {
       ...
       // Toast.makeText(context,"media player started",Toast.LENGTH_SHORT).show();
        ...
        if(AType.equals("MONTHLY_EXPENSE")) {
            ...
            if (NotifyType.equals("Notification") || NotifyType.equals("Both")) {
                ...
                notificationHelper.getManager().notify("com.newage.aquapets",intentID, nb.build());
    ...
    private void monthlyExpenseNotification(Context context, Intent intent) {
        ...
        if(!expense.isEmpty()) {
            ...
            notificationHelper.getManager().notify("com.newage.aquapets",getID(), nb.build());
        }
